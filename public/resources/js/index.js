...
function widgetFlags(user) {
  ...
  if (user.premium_since != "none") {
    nitro = `<img class="uk-preserve" style="${house == "" ? "" : "margin-left: 5px;"}" src="/resources/svg/widget/386884eecd36164487505ddfbac35a9d.svg" width=${wh} height=${wh} uk-svg />`;
  }

  return `<div class="uk-flex uk-flex-row" uk-tooltip="${house_name}">${house}</div> ${nitro}`
};
